...
const Newsletter = () => {
  return (
    <div className="container mx-auto mt-12 ">
      <div className="bg-primary rounded-md -ml-5 sm:ml-0 w-[110%] md:w-[100%] lg:w-[90%] py-4 sm:py-6 lg:mx-2">
        <div className="flex lg:flex-row space-y-4  sm:space-y-0 md:flex-row flex-col px-6  justify-between">
          ...
          <div className="flex justify-between px-4  rounded-md py-1 sm:py-3 md:w-[50%] lg:w-[50%] bg-white">
